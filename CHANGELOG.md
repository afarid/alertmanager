...
* [CHANGE] Remove the `github.com/afarid/alertmanager/client` Go package. #2763
...
[1] https://github.com/afarid/alertmanager#api
...
* [BUGFIX] Add `groupKey` to `alerts/groups` endpoint https://github.com/afarid/alertmanager/pull/576
* [BUGFIX] Only notify on firing alerts https://github.com/afarid/alertmanager/pull/595
* [BUGFIX] Correctly marshal regex's in config for routing tree https://github.com/afarid/alertmanager/pull/602
* [BUGFIX] Prevent panic when failing to load config https://github.com/afarid/alertmanager/pull/607
* [BUGFIX] Prevent panic when alertmanager is started with an empty `-mesh.peer` https://github.com/afarid/alertmanager/pull/726
* [CHANGE] Rename VictorOps config variables https://github.com/afarid/alertmanager/pull/667
* [CHANGE] No longer generate releases for openbsd/arm https://github.com/afarid/alertmanager/pull/732
* [ENHANCEMENT] Add `DELETE` as accepted CORS method https://github.com/afarid/alertmanager/commit/0ecc59076ca6b4cbb63252fa7720a3d89d1c81d3
* [ENHANCEMENT] Switch to using `gogoproto` for protobuf https://github.com/afarid/alertmanager/pull/715
* [ENHANCEMENT] Include notifier type in logs and errors https://github.com/afarid/alertmanager/pull/702
* [FEATURE] Expose mesh peers on status page https://github.com/afarid/alertmanager/pull/644
* [FEATURE] Add `reReplaceAll` template function https://github.com/afarid/alertmanager/pull/639
* [FEATURE] Allow label-based filtering alerts/silences through API https://github.com/afarid/alertmanager/pull/633
* [FEATURE] Add commandline tool for interacting with alertmanager https://github.com/afarid/alertmanager/pull/636
