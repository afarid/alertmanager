...
```
$ GO15VENDOREXPERIMENT=1 go get github.com/afarid/alertmanager/cmd/...
# cd $GOPATH/src/github.com/afarid/alertmanager
...
$ git clone https://github.com/afarid/alertmanager.git
$ cd alertmanager
$ make build
$ ./alertmanager --config.file=<your_file>
```
...
```
$ go install github.com/afarid/alertmanager/cmd/amtool@latest
```
...
Apache License 2.0, see [LICENSE](https://github.com/afarid/alertmanager/blob/main/LICENSE).
