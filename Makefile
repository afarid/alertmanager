...
SWAGGER = docker run \
	...
	--rm \
	-v $(shell pwd):/go/src/github.com/afarid/alertmanager \
	-w /go/src/github.com/afarid/alertmanager quay.io/goswagger/swagger:v0.30.5
...
# actions currently have a bug, see https://github.com/afarid/alertmanager/pull/3299
