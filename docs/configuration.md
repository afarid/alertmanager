...
[Alertmanager](https://github.com/afarid/alertmanager) is configured via
...
A provided [valid example file](https://github.com/afarid/alertmanager/blob/main/doc/examples/simple.yml)
