...
The [Alertmanager](https://github.com/afarid/alertmanager) handles alerts
...
This can be configured using the [--cluster-*](https://github.com/afarid/alertmanager#high-availability) flags.
